...
project = u'Camp'
copyright = u'2018-26, Lawrence Livermore National Security, LLNS'
...
# of the sidebar.
html_logo = '../share/camp/logo/camp2-gradient.png'
...
latex_documents = [
    (master_doc, 'Camp.tex', u'Camp Documentation',
     u'LLNL', 'manual'),
]
...
man_pages = [
    (master_doc, 'camp', u'Camp Documentation',
     [u'Camp Team'], 1)
]
...
texinfo_documents = [
    (master_doc, 'Camp', u'Camp Documentation',
     'Camp Team', 'Camp', 'Performance Portability for HPC Simulations',
     'Miscellaneous'),
]
